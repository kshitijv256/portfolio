...
const Intro = () => {
  return (
    <div className="bg-slate-800 py-10 mx-4 rounded-xl mt-20">
      <div className="flex flex-col items-center justify-start p-10">
        <div className="flex flex-row items-center gap-10">
          <img
            className="object-center object-cover rounded-full h-36 w-36 group-hover:ring-8 ring-violet-700 ring-8 sm:ring-0"
            src={kshitij}
            alt="logo"
          />
          <div>
